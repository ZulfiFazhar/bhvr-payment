...
Learn how to integrate SumoPod payment gateway into your application

### Your API Keys

My BHVR

`9ff50150f42c6419c2caa883f5f3d9bdc985c345a29f10c442ad272fde644971`

### Create Payment

Use our API to create payment links for your customers.
...
Settles in 2 daysFee: 0.7% + Rp 300
...
`expires_in_hours` is optional, defaults to 24 hours if omitted.

`success_return_url` and `cancel_return_url` are optional, override your project's configured return URLs for this payment only.

`payment_method_type_code` is optional, get it from the "Supported Payment Methods" list shown to the left.
...
Use the raw, unparsed request body. A single re-formatted whitespace character will break the signature match. We recommend using [Svix's official verification libraries](https://docs.svix.com/receiving/verifying-payloads/how) instead of hand-rolling this in production.
